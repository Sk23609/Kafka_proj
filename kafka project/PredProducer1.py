# -*- coding: utf-8 -*-
"""
Created on Sun Sep 23 09:14:43 2018
...
while True:
        ...
        ValueBytesObject=bytes(str(balls), encoding='utf-8')+bytes(len(team1.text.encode('utf-8')),encoding='utf-8')+bytes(team1.text,encoding='utf-8')+bytes(len(team2.text.encode('utf-8')),encoding='utf-8')+bytes(team2.text,encoding='utf-8')
        print("encoded")
